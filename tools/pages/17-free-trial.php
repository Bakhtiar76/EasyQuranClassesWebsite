...
$hero = eqc_page_hero(
	...
	"Tell us the student's age, level and a few details. We'll match a suitable teacher and confirm your trial, usually within a day.",
	'calendar'
);

// ------------------------------------------------------- WHAT HAPPENS NEXT
$steps = array(
	array( 'book-open', 'You Submit This Form', "Share the student's age, level and country." ),
...
foreach ( $steps as $i => $s ) {
	$step_cards[] = eqc_html(
		'<div class="eqc-card" style="text-align:center;" data-eqc-reveal data-eqc-reveal-index="' . (int) $i . '">'
...
$alt_contact_html =
	...
	. '<div style="margin-top:1.2em;display:flex;flex-direction:column;gap:0.75rem;align-items:stretch;">'
	. '<a class="eqc-btn eqc-btn--whatsapp eqc-btn--block-sm" href="' . eqc_whatsapp_url( "Assalamu alaikum, I'd like to ask about a free trial class." ) . '">' . eqc_icon_str( 'whatsapp' ) . ' Chat on WhatsApp</a>'
	. '<a class="eqc-btn eqc-btn--bronze eqc-btn--block-sm" href="' . esc_url( home_url( '/contact/' ) ) . '">' . eqc_icon_str( 'mail' ) . ' Contact Us</a>'
	. '</div>'
...
$form_section = eqc_section(
	'eqc-section eqc-section--cream eqc-trial-form-section',
	array(
		eqc_inner(
			'',
			array(
