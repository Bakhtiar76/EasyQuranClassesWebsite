...
| Home / about stats | Students Taught 5,000 | Home2.jpeg | tools/pages/10-home.php eqc_about_stat() call | Is 5,000 the real number of students taught, and over what period? | Load-bearing: three-column stat row |
| Home / about stats | Countries Served 10 | Home2.jpeg | tools/pages/10-home.php eqc_about_stat() call | How many countries do students actually join from? Note the hero trust strip says "20+" - the reference itself is inconsistent and the client must reconcile the two. | Load-bearing stat |
| Home / about body | "Nobody else is in the room. Nobody is watching you make mistakes." | Home2.jpeg | tools/pages/10-home.php about paragraph 2 | Confirm this describes how the classes actually run (1-to-1, no observers). | Two-line paragraph tail |
